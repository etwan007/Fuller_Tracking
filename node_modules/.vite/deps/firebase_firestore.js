  ...
  wn(e) {
    ...
    if (this.fn.size > 0) {
      ...
      if (!r.has(e2.field.canonicalString())) {
        const t2 = n[i];
        if (!this.Sn(e2, t2) || !this.Dn(this.gn[s++], t2))
          return false;
      }
      ++i;
    }
...
var __PRIVATE_QueryEngine = class {
  ...
  getDocumentsMatchingQuery(e, t, n, r) {
    ...
    return this.ws(e, t).next((e2) => {
      ...
      if (!i.result)
        return this.bs(e, t, r, n).next((e2) => {
          i.result = e2;
        });
    }).next(() => {
      if (i.result)
...
async function __PRIVATE_onWatchStreamChange(e, t, n) {
  ...
  else if (t instanceof __PRIVATE_DocumentWatchChange ? e.ma.Xe(t) : t instanceof __PRIVATE_ExistenceFilterChange ? e.ma.ot(t) : e.ma.nt(t), !n.isEqual(SnapshotVersion.min()))
    try {
...
var __PRIVATE_BundleLoader = class {
  ...
  Wa(e) {
    ...
    if (e.$a.namedQuery)
      this.queries.push(e.$a.namedQuery);
      ...
      e.$a.document && (this.documents[this.documents.length - 1].document = e.$a.document, ++t);
...
async function __PRIVATE_syncEngineUnlisten(e, t, n) {
  ...
  if (s.length > 1)
    return r.Pu.set(i.targetId, s.filter((e2) => !__PRIVATE_queryEquals(e2, t))), void r.hu.delete(t);
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const r of e.Pu.get(t))
    e.hu.delete(r), n && e.lu.gu(r, n);
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r of n)
    if (r instanceof __PRIVATE_AddedLimboDocument)
      e.du.addReference(r.key, t), __PRIVATE_trackLimboChange(e, r);
  ...
  Ec() {
    if (this.path)
      for (let e = 0; e < this.path.length; e++)
        this.Vc(this.path.get(e));
  }
  Vc(e) {
    if (0 === e.length)
      throw this.gc("Document fields must not be empty");
    if (__PRIVATE_isWrite(this.Ic) && cn.test(e))
      throw this.gc('Document fields cannot begin and end with "__"');
  }
};
...
var __PRIVATE_DeleteFieldValueImpl = class ___PRIVATE_DeleteFieldValueImpl extends FieldValue {
  _toFieldTransform(e) {
    if (2 !== e.Ic)
      throw 1 === e.Ic ? e.gc(`${this._methodName}() can only appear at the top level of your update data`) : e.gc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);
...
function __PRIVATE_parseData(e, t) {
  ...
  if (e instanceof FieldValue)
    return function __PRIVATE_parseSentinelFieldValue(e2, t2) {
      if (!__PRIVATE_isWrite(t2.Ic))
        throw t2.gc(`${e2._methodName}() can only be used with update() and set()`);
      if (!t2.path)
        throw t2.gc(`${e2._methodName}() is not currently supported inside arrays`);
  ...
  if (
    ...
    if (t.settings.Rc && 4 !== t.Ic)
      throw t.gc("Nested arrays are not supported");
  ...
  return function __PRIVATE_parseScalarValue(e2, t2) {
    ...
    if (e2 instanceof DocumentReference) {
      ...
      if (!r.isEqual(n))
        throw t2.gc(`Document reference is for database ${r.projectId}/${r.database} but should be for database ${n.projectId}/${n.database}`);
      return {
            ...
            [Tt]: {
              arrayValue: {
                values: e3.toArray().map((e4) => {
                  if ("number" != typeof e4)
                    throw t3.gc("VectorValues must only contain numeric values.");
